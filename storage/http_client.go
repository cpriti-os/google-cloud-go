...
func parseReadResponse(res *http.Response, params *newRangeReaderParams, reopen func(int64) (*http.Response, error), instruments *metricInstruments) (r *Reader, err error) {
	defer func() {
		if err != nil {
			res.Body.Close()
		}
